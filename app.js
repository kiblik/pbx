...
var mgmt_e2p_data = require('./routes/mgmt_e2p_data');
var mgmt_asctea2ext = require('./routes/mgmt_asctea2ext');
var mgmt_asctea2ext_data = require('./routes/mgmt_asctea2ext_data');
var mgmt_asccab2ext = require('./routes/mgmt_asccab2ext');
var mgmt_asccab2ext_data = require('./routes/mgmt_asccab2ext_data');
...
app.use('/mgmt/e2p/data', mgmt_e2p_data);
app.use('/mgmt/asctea2ext', mgmt_asctea2ext);
app.use('/mgmt/asctea2ext/data', mgmt_asctea2ext_data);
app.use('/mgmt/asccab2ext', mgmt_asccab2ext);
app.use('/mgmt/asccab2ext/data', mgmt_asccab2ext_data);
